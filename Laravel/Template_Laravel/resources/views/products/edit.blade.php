                    ...
                    <form enctype="multipart/form-data" action="{{ route('products.update' , $product->id) }}" method="post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea placeholder="Description" class="@error('description') is-invalid @enderror form-control-lg form-control" name="description" cols="30" rows="5">{{ old('description' , $product -> description) }}</textarea>
                                @error('description')
                                <p class="invalid-feedback">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <input placeholder="Phone" class="@error('phone') is-invalid @enderror form-control-lg form-control" name="phone" value="{{ old('phone' , $product -> phone) }}" type="text">
                                @error('phone')
                                <p class="invalid-feedback">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <input placeholder="Email" class="@error('email') is-invalid @enderror form-control-lg form-control" name="email" value="{{ old('email' , $product -> email) }}" type="email">
                                @error('email')
                                <p class="invalid-feedback">{{ $message }}</p>
                                @enderror
                            </div>
